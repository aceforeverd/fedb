...
void DefaultUdfLibrary::InitTimeAndDateUdf() {
    ...
    RegisterExternal("datediff")
        ...
        .doc(R"(
            ...
            @since 0.7.0)");
    RegisterExternal("datediff")
        .args<StringRef, StringRef>(static_cast<void (*)(StringRef*, StringRef*, int64_t*, bool*)>(v1::date_diff));
    RegisterExternal("datediff")
        .args<StringRef, Date>(static_cast<void (*)(StringRef*, Date*, int64_t*, bool*)>(v1::date_diff));
    RegisterExternal("datediff")
        .args<Date, StringRef>(static_cast<void (*)(Date*, StringRef*, int64_t*, bool*)>(v1::date_diff));
